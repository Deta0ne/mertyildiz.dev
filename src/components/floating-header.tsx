...
export const FloatingHeader = memo(({ scrollTitle, title, goBackLink, children }: FloatingHeaderProps) => {
    ...
    return (
        <header className="sticky inset-x-0 top-0 z-50 mx-auto flex h-14 w-full shrink-0 items-center border-b bg-background/80 backdrop-blur-sm text-sm font-medium md:hidden">
